...
namespace Persistencias
{
    public class PersistenciasPreguntas
    {
        ...
        public static List<Pregunta> ListarPreguntasJuego(Juegos pJuego)
        {
            ...
            oComando.Parameters.AddWithValue("@codigoJuego", pJuego.CodigoJuego);
        ...
        public static int ModificarPregunta(Pregunta pPregunta)
        {
            SqlConnection oConexion = new SqlConnection(Conexion.Con);
