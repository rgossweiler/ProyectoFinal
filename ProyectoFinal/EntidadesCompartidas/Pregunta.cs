...
namespace EntidadesCompartidas
{
    ...
    {
        //ATRIBUTOS
        private string textoPregunta; //Cambio "preguntas" X "textoPregunta" 11/feb IDEM Propiedad y Constructor
        ...
        //CONSTRUCTOR
        public Pregunta(string pTextoPregunta, string pRespuesta1, string pRespuesta2, string pRespuesta3, int pCorrecta, string pCodPregunta, int pPuntaje, Categorias pCategoria)
        {
